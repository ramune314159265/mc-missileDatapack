...
# 半径100マスのエンティティにダメージ
	execute as @a[gamemode=!creative,gamemode=!spectator,distance=1..100] run damage @s 1024 ramune_missile:missile_blast
	execute as @e[type=!player,distance=1..100] run damage @s 1024 ramune_missile:missile_blast
