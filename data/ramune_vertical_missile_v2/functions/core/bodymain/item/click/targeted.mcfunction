#ミサイル本体
summon minecraft:item_display ~ ~ ~ {item:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:31401}},Tags:["missile_main","has_target","target_tmp","missile_ready"],teleport_duration:4,interpolation_duration:100}
