...
# マーカーをスコア値分移動
	execute if score @s r_vmissile2_calc matches 256.. as @e[tag=missile_tp_tmp,limit=1,sort=nearest] at @s run tp ~ ~6.4 ~
	...
	execute if score @s r_vmissile2_calc matches 16.. as @e[tag=missile_tp_tmp,limit=1,sort=nearest] at @s run tp ~ ~0.4 ~
	execute if score @s r_vmissile2_calc matches 16.. run scoreboard players remove @s r_vmissile2_calc 16
	execute if score @s r_vmissile2_calc matches 8.. as @e[tag=missile_tp_tmp,limit=1,sort=nearest] at @s run tp ~ ~0.2 ~
	execute if score @s r_vmissile2_calc matches 8.. run scoreboard players remove @s r_vmissile2_calc 8
	execute if score @s r_vmissile2_calc matches 4.. as @e[tag=missile_tp_tmp,limit=1,sort=nearest] at @s run tp ~ ~0.1 ~
	execute if score @s r_vmissile2_calc matches 4.. run scoreboard players remove @s r_vmissile2_calc 4
	execute if score @s r_vmissile2_calc matches 2.. as @e[tag=missile_tp_tmp,limit=1,sort=nearest] at @s run tp ~ ~0.05 ~
